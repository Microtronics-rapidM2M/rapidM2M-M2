 ...
 *
 * The state machine has six different states that are indicated by the RGB LED 1:
...
StateChange(iNewState)
{
  switch(iNewState)                            // Switch new state for the application 
  {
    ...
    {
      // RGB LED should light up yellow
      rM2M_GpioSet(PIN_LED1_R,  LED_ENABLE);
